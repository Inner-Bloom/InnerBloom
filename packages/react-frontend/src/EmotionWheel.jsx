...
const EmotionWheel = () => {
    ...
    const [selectedItem_slp, setSelectedItem_slp] = useState("Sleep");

    const [selectedItem_eat, setSelectedItem_eat] = useState("Eat");

    const [selectedItem_exe, setSelectedItem_exe] = useState("Exercise");
                        ...
                        <form>
                            ...
                            <div>
                                <select
                                    ...
                                    value={selectedItem_slp}
                                    onChange={handleChange_slp}>
                                ...
                                <select
                                    className="eat-amnt"
                                    value={selectedItem_eat}
                                    onChange={handleChange_eat}>
                                ...
                                <select
                                    className="exercise-amnt"
                                    value={selectedItem_exe}
                                    onChange={handleChange_exe}>
